...
$(document).ready(function() {
		console.log("calling this nigga");
     ...
     $.ajax({
              ...
              success: function (result) {  
            	  ...
            	  $.each(result , function(index, vehicule){
            		  ...
            		  $('#vehiculeList tr:last').after("<tr class='VehiculeRows'> <td>"+vehicule.categorie +"</td> <td>"
            				  +vehicule.marque+"</td>"
            				  +"<td>"+vehicule.model+"<span class='label label-warning label-sm'>en Attente</span></td>"
...
function updateDepotList( ){
	      	
    console.log("update depot called");
	      	...
	      	$.ajax({
	              ...
	              success: function (result) {  
	            	  ...
	            	  $.each(result , function(index, element){
	              	   $("#depots").append("<option>"+ element +"</option>")   
	                 });
	    ...
	    $("#depots").change(updateVehiculeList);
      ...
      <div class="page-content">
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <h3 class="page-title">
                  Gérer Dépot <small>gestion des dépots</small>
               </h3>
               <ul class="page-breadcrumb breadcrumb">
                  ...
                  <li>
                     <a href="/BO/addVehicule">Gérer depot</a>
                     <i class="icon-angle-right"></i>
                  </li>
                  <li><a href="/BO/depStat">Etablir l'état d'un dépot</a></li>
               </ul>
				          ...
				          <!-- END PAGE CONTENT-->
                            ...
                            <div class="portlet box red center-block">
                                ...
                                <div class="form-group">
                                                ...
                                                <label class="label label-md label-warning">Nom dépot</label>
                                                <i class="icon-font"></i>
                                               <select id="depots" type="text"  class="form-control">
                                               </select>
