	      	...
	      	$.ajax({
	              ...
	              success: function (result) {  
	            	  ...
	            	  $.each(result , function(index, element){
	              	   $("#depots").append("<option value='"+element.idDepot+"'>"+ element.name +"</option>")   
	                 });
                        ...
                        <div class="sidebar-content col-md-6 ">
                            ...
                            <div class="portlet box red center-block">
                                <div class="portlet-title line">
                                    <div class="caption"><i class="icon-comments"></i>Ajouter Agent</div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                    <h4></h4>
                          	          ...
                          	          <form:form modelAttribute="user"  action="/BO/registerAgent"  method="post"  id='addForm' enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="input-icon">         
                                               ...
                                               <h3 style="color:red;">${message2}</h3>
                                                <i class="icon-font"></i>
                                                <form:input id="pass" path="pass" type="password" required="Champ obligatoire" class="form-control" />
                                            </div>
                                        </div>
													
                                        <div class="form-group">
                                            <label class="label label-md label-warning">Dépot</label>
                                            <form:select path="depot" id="depots" class="form-control  input">
                                      ...
                                      <button id="registerAgent" type="submit" class=" btn-block btn red">Ajouter</button>
                                        <form:input type="hidden" path="rol" value="ROLE_AGENT" />
