                ...
                <sec:authorize access="hasRole('ROLE_ADMIN')"> 
                  <li  class="active" >
                     ...
                     <ul class="sub-menu">
                        ...
                        <li class="active"><a href="/BO/removeAgent">Retirer agent</a></li>
                        ...
                        <div class="sidebar-content col-md-6 ">
                            ...
                            <div class="portlet box red center-block">
                                <div class="portlet-title line">
                                    <div class="caption"><i class="icon-comments"></i>Supprimer Agent</div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                   <h3 style="color:red">${msgError}</h3>
                          	          ...
                          	          <form:form modelAttribute="user"  action="/BO/removeAgent"  method="POST"  id='addForm' >
