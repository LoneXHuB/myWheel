...
<body>
	...
	<!-- start slider -->
               ...
               <img src="images/slider1.jpg" class="img-responsive" alt=""/>
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        ...
                        <!-- /Text title -->
                        <div class="button"><a href="/shop/0">Voir nos Offres!</a></div>
                    </div>
                </div>
               <!-- /Texts container -->
            </div>
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h1 class="title">Run Over<br>Everything</h1>
                       	<div class="button"><a href="/shop/0">Voir Details</a></div>
                    </div>
                </div>
            </div>
            <!--/slide -->
	  ...
	  <div class="main">
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.flexisel.js"></script>
		</div>
	</div>
