                ...
                <sec:authorize access="hasRole('ROLE_ADMIN')"> 
                  <li  >
                     ...
                     <ul class="sub-menu">
                        ...
                        <li c><a href="/BO/removeAgent">Retirer agent</a></li>
                  ...
                  <li  class="active" >
                    ...
                    Gérer comptes clients
                     ...
                     <ul class="sub-menu">
                        ...
                        <li  class="active"><a href="/BO/removeClient">Retirer client</a></li>
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <ul class="page-breadcrumb breadcrumb">
                  ...
                  <li><a href="/BO/removeAgent">Supprimer Agent</a></li>
               </ul>
                        ...
                        <div class="sidebar-content col-md-6 ">
                            ...
                            <div class="portlet box red center-block">
                                <div class="portlet-title line">
                                    <div class="caption"><i class="icon-comments"></i>Supprimer Client</div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                   <h3 style="color:red">${msgError}</h3>
                          	          ...
                          	          <form:form modelAttribute="user"  action="/BO/removeClient"  method="POST"  id='addForm' >
                                        <div class="form-group">
                                            <div class="input-icon">
                                                <label class="label label-md label-warning">Email</label>
                                                <i class="icon-font"></i>
                                                <form:input id="email" name="email" path="email" required="champ obligatoire" type="text" class="form-control" />
                                            </div>
                                        </div>
