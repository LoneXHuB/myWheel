    ...
    <div class="header-inner">
        ...
        <div class="hor-menu hidden-sm hidden-xs">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a id="locataires" >Locataires

                    </a>

                </li>
                <li  >
                    <a  id="gestionnaires">Gestionnaires
...
<div class="page-container" >
    ...
    <div class="row col-md-12" id="menu2">
        ...
        <ul class="page-sidebar-menu ">
            <li class="start col-md-pull-3 btn " >
                <a id="listevoitures">
                    <i class=" icon-list-ul"></i>
                    <span class="title"  >Liste des voitures</span>
                </a>
            </li>
            <li class="start col-md-pull-3 btn bg" style="font-family:inh">
                <a id="listebus">
                    <i class=" icon-list-ul"></i>
